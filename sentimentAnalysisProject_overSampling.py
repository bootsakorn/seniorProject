...
print('pos: {}'.format(len(pos)))
print('neg: {}'.format(len(neg)))
print('dataTrainPos: {}'.format(len(dataTrainPos)))
print('dataTrainNeg: {}'.format(len(dataTrainNeg)))
print('dataTestPos: {}'.format(len(dataTestPos)))
print('dataTestNeg: {}'.format(len(dataTestNeg)))
